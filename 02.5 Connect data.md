...
17. Within the properties pane to the right of the screen, change the **Columns** value to **1**. This setting modifies the layout of the edited form to be a single column.
    ...
    For more information, see [Understand data-form layout for canvas apps](https://powerapps.microsoft.com/tutorials/working-with-form-layout/).
...
1. Open a browser window and then go to [Make Power Apps](https://make.powerapps.com/).
...
1. Open a browser window and then go to [Make Power Apps](https://make.powerapps.com/). Sign in if needed.
